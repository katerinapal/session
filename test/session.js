...
describe('session()', function () {
  it('should export constructors', function () {
    _assert2.default.strictEqual(_typeof(_.session.Session), 'function');
    _assert2.default.strictEqual(_typeof(_.session.Store), 'function');
    _assert2.default.strictEqual(_typeof(_.session.MemoryStore), 'function');
  });
